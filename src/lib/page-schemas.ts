...
export const pageSchemas: PageSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "hero_description", label: "Hero — sous-titre", type: "textarea", default: "À seulement 30 minutes de Grasse, Antibes, Cannes, Fréjus-Saint-Raphaël ou Draguignan : un domaine privé en Provence pour vos séminaires d'entreprise." },
